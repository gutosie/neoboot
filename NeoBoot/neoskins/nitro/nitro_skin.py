...
if not fileExists('/etc/vtiversion.info'):          
    ...
    <widget name="label1" position="1194,127" size="720,48" zPosition="1" halign="left" font="Regular; 34" foregroundColor="#00FF00" backgroundColor="background" transparent="1" />
    <widget name="label2" position="75,145" zPosition="1" size="652,46" font="Regular; 30" halign="left" valign="center" backgroundColor="background" transparent="1" />
    <widget name="label3" position="75,473" zPosition="1" size="540,99" font="Regular; 28" halign="center" valign="center" backgroundColor="background" transparent="1" foregroundColor="yellow" />
    <widget name="label4" position="75,210" zPosition="1" size="550,46" font="Regular; 30" halign="left" valign="center" backgroundColor="background" transparent="1" />
    <widget name="label5" position="809,145" zPosition="1" size="340,46" font="Regular; 30" halign="right" valign="center" backgroundColor="background" transparent="1" foregroundColor="blue" />
    <widget name="label6" position="628,210" zPosition="1" size="521,46" font="Regular; 30" halign="right" valign="center" backgroundColor="background" transparent="1" foregroundColor="yellow" />
    <widget name="label7" position="842,273" zPosition="1" size="308,46" font="Regular; 30" halign="right" valign="center" backgroundColor="background" transparent="1" foregroundColor="green" />
    <widget name="label8" position="75,273" zPosition="1" size="666,46" font="Regular; 30" halign="left" valign="center" backgroundColor="background" transparent="1" />
    <widget name="label9" position="433,77" zPosition="1" size="720,46" font="Regular; 30" halign="right" valign="center" backgroundColor="background" transparent="1" foregroundColor="red" />    
    <widget name="label10" position="964,336" zPosition="1" size="185,46" font="Regular; 30" halign="right" valign="center" backgroundColor="background" transparent="1" foregroundColor="green" />
    <widget name="label13" position="75,336" zPosition="1" size="415,46" font="Regular; 30" halign="left" valign="center" backgroundColor="background" transparent="1" />
    <widget name="label14" position="73,77" zPosition="1" size="350,46" font="Regular; 30" halign="left" valign="center" backgroundColor="background" transparent="1" />
    <widget name="label15" position="75,408" zPosition="1" size="265,46" font="Regular; 30" halign="left" valign="center" backgroundColor="background" foregroundColor="yellow" transparent="1" />
    ...
    <widget name="label22" position="780,445" zPosition="1" size="390,60" font="Regular;30" halign="center" valign="center" backgroundColor="background" transparent="1" foregroundColor="#00FF00" />
    <widget name="label23" position="780,445" zPosition="1" size="390,60" font="Regular;30" halign="center" valign="center" backgroundColor="background" transparent="1" foregroundColor="#00FF00" />
    <widget name="label24" position="780,510" size="390,60" font="dugme;30" halign="center" valign="center" zPosition="1" backgroundColor="black" transparent="1" foregroundColor="#00FF00" />
    <widget name="label25" position="781,409" size="413,174" font="dugme;30" halign="center" valign="center" zPosition="1" backgroundColor="black" transparent="1" foregroundColor="#00FF00" />    
    ...
    <widget source="global.CurrentTime" render="Label" position="1404,84" size="450,38" backgroundColor="background" transparent="1" zPosition="1" font="Regular;24" valign="center" halign="right">
    ...
    <widget name="key_menu" position="140,848" zPosition="1" size="390,46" font="Regular;30" halign="left" valign="center" backgroundColor="background" transparent="1" foregroundColor="#99ffff" />
    </screen>
    """
else:
    ImageChooseFULLHD = """ 
