    ...
    def first_installationNeoBoot(self):
            ...
            # STB MIPS
                        ...
                        if getBoxHostName() == "et5x00":
                                os.system('cd ' + LinkNeoBoot + '/; cp -af ./bin/neoinitmips /sbin/neoinitmips; cp -af ./bin/neoinitarmvuDuo4k ./bin/neoinitmipsvu; cp -af ./bin/neoinitarmvuDuo4k ./sbin/neoinitmipsvu; cd')
