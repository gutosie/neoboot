    ...
    def first_installationNeoBoot(self):
            ...
            if getCPUtype() == "ARMv7":
                if getBoxHostName() == "vuduo4k" and getBoxHostName() != "ustym4kpro":
                        ...
                        if fileExists('/media/usb/ImageBoot/.neonextboot') and not fileExists('/media/hdd/ImageBoot/.neonextboot')::
                        ...
                        elif fileExists('/media/hdd/ImageBoot/.neonextboot') and not fileExists('/media/usb/ImageBoot/.neonextboot'):
